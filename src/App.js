...
import Films from "./Film/filmsList";
import Film from "./Film/filmById";
    ...
    <div className={classes.root}>
      ...
      <BrowserRouter>
        ...
        <main className={classes.content}>
          ...
          <Switch>
            <Route exact path="/" render={() => <div>Page Login</div>} />
            <Route path="/film/:id" component={Film} />
            <Route path="/films" component={Films} />
            <Route path="/login" render={() => <div>Page Login</div>} />
          </Switch>
        </main>
      </BrowserRouter>
    </div>
